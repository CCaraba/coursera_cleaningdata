...
A new data frame is created with subjects, labels and the described features.
Step 3:
...
Proceed to tidy the list by removing all non-alphanumeric characters and converting the result to lowercase
